...
import { CheckCircle, Clock, AlertTriangle, StickyNote, FolderKanban, ListTodo } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const isEmpty = data.total_tasks === 0 && data.project_summaries.length === 0 && data.pending_notes === 0
    ...
    <div className="mx-auto max-w-lg p-4 space-y-6">
      ...
      {isEmpty && (
        <div className="py-16 text-center text-muted-foreground">
          ...
          <p className="mt-1 text-sm">通过 AI 对话创建项目和任务</p>
        </div>
      )}
    </div>
  )
